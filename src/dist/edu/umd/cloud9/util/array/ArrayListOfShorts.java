...
public class ArrayListOfShorts implements RandomAccess, Cloneable, Iterable<Short> {
   ...
   * list does not contain the element. Note that this method performs a linear scan of the list.
   *
   * @return index of first occurrence of element, or -1 if list does not contain the element.
   */
   ...
   * list does not contain the element. Note that this method performs a linear scan of the list.
   *
   * @return index of last occurrence of element, or -1 if list does not contain the element.
   */
   ...
   * conform to the {@link Iterable} interface; this method is not efficient because of autoboxing.
   *
  ...
  /**
   * Returns a string representation of this list, explicitly enumerating the first <i>n</i>
  ...
  /**
   * Sorts elements of this list in ascending order.
   */
  public void sort() {
    trimToSize();
   ...
   * @return a new {@code ArrayListOfShorts} from {@code start} to {@code end}
   */
